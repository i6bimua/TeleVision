...
# Import py360convert for cubemap to equirectangular conversion
try:
    import py360convert
...
if __name__ == '__main__':
    ...
    teleoperator = VuerTeleop(str(config_path))
    simulator = Sim(print_freq=args.print_freq, use_panorama=not args.no_panorama)
